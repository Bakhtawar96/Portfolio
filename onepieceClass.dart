...
class onepieceClass extends StatefulWidget {
  const onepieceClass({super.key, required categoryName, required categoryImageUrl});

  @override
  State<onepieceClass> createState() => _HomeClassState();
}

class _HomeClassState extends State<onepieceClass> {
  ...
  Future<void> _fetchImageUrls() async {
    ...
    DatabaseReference databaseReference = FirebaseDatabase.instance.ref("FlutterDatabase/one piece");
    try {
