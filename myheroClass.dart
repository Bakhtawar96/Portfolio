...
class myheroClass extends StatefulWidget {
  const myheroClass({super.key, required categoryName, required categoryImageUrl});

  @override
  State<myheroClass> createState() => _HomeClassState();
}

class _HomeClassState extends State<myheroClass> {
  ...
  Future<void> _fetchImageUrls() async {
    ...
    DatabaseReference databaseReference = FirebaseDatabase.instance.ref("FlutterDatabase/my hero");
    try {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('My Hero Academia', style: TextStyle(color: Colors.white,),),
